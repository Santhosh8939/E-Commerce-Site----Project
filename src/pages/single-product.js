...
class SingleProduct extends Component {
  ...
  componentDidMount() {
    ...
    const productURL =
      "https://shop143.herokuapp.com/telebuy/api/product/" + productId;
    axios
      .get(productURL)
      .then((response) => {
        this.setState({
                    ...
                    <div class="col-sm-6">
                      <div class="product-images">
                        ...
                        <div class="product-gallery">
                          <img
                            src={
                              require("../images/product-thumb-1.jpg").default
                            }
                            alt=""
                          />
                          <img
                            src={
                              require("../images/product-thumb-2.jpg").default
                            }
                            alt=""
                          />
                          <img
                            src={
                              require("../images/product-thumb-3.jpg").default
                            }
                            alt=""
                          />
                        </div>
                    ...
                    <div class="col-sm-6">
                      <div class="product-inner">
                        ...
                        <div class="product-inner-price">
                          <ins>{this.state.productInfo.discount_price}</ins>{" "}
                          <del>{this.state.productInfo.actual_price}</del>
                        </div>
